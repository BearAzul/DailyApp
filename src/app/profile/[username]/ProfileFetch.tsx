...
import { Edit, FileText, Heart, Calendar, MapPin, Link } from "lucide-react";
    ...
    <div className="max-w-3xl mx-auto">
      <div className="grid grid-cols-1 gap-6">
        ...
        <Tabs defaultValue="posts" className="w-full">
          <TabsList className="w-full justify-start border-b h-auto p-0 rounded-none bg-transparent">
            <TabsTrigger
              value="posts"
          ...
          <TabsContent value="posts" className="mt-6">
            <div className="space-y-6">
              {posts.length > 0 ? (
                posts.map((post) => (
                  <CardPosts key={post.id} post={post} dbUserId={user.id} />
                ))
              ) : (
